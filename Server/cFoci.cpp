...
/**
 *	@file cFoci.cpp
 *	Handles the foci object functions.
 *
 *	This class is referenced whenever a foci is created, used, or assessed.
...
/**
 *	Handles the message sent for the creation of foci in the world.
 *
 *	This function is called whenever a foci should be created in the world for a client.
 *
 *	@return cMessage - Returns a Create Object (0x0000F745) server message.
 */
cMessage cFoci::CreatePacket( )
{
	cMessage cmReturn;
...
/**
 *	Handles the message sent for the creation of foci in a container.
 *
 *	This function is called whenever a foci should be created in the inventory of another object.
 *
 *	@return cMessage - Returns a Create Object (0x0000F745) server message.
 */
cMessage cFoci::CreatePacketContainer(DWORD Container, DWORD ItemModelID)
{
	...
	cmReturn << 0xE2468120; //Decode this later...
...
/**
 *	Handles the actions of foci objects.
 *
 *	This function is called whenever a foci is used or should perform an action.
 */
void cFoci::Action(cClient *who)
{

}

/**
 *	Handles the assessment of foci objects.
 *
 *	This function is called whenever a foci is assessed by a client.
 *
 *	Returns a Game Event (0x0000F7B0) server message of type Identify Object (0x000000C9).
 */
void cFoci::Assess( cClient *pcAssesser )
{
	cItemModels *pcModel = cItemModels::FindModel( m_dwItemModelID );
	...
	<< flags 
	<< 0x00L;		//Success = 0x01, Failure = 0x00
