...
/**
 *	@file cSpellComponents.cpp
 *	Implements functionality for spell components.
 *
 *	This class is referenced whenever a spell component is created, used, or assessed.
 ...
 */
cMessage cSpellComps::CreatePacket( )
{
	cMessage cmReturn;
 ...
 *	@return cMessage - Returns a Create Object (0x0000F745) server message.
 */
cMessage cSpellComps::CreatePacketContainer(DWORD Container, DWORD ItemModelID)
{
	cMessage cmReturn;
 ...
 */
void cSpellComps::Action(cClient *who)
{
 ...
 */
void cSpellComps::Assess( cClient *pcAssesser )
{
	cItemModels *pcModel = cItemModels::FindModel( m_dwItemModelID );
