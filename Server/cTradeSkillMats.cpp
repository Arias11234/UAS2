...
/**
 *	@file cTradeSkillMats.cpp
 *	Implements functionality for materials for trade skills.
 *
 *	This class is referenced whenever a trade skill material is created, used, or assessed.
...
/**
 *	Handles the message sent for the creation of trade skill materials in the world.
 *
 *	This function is called whenever a trade skill material should be created in the world for a client.
 *
 *	@return cMessage - Returns a Create Object (0x0000F745) server message.
 */
cMessage cTradeSkillMats::CreatePacket( )
{
	cMessage cmReturn;
	...
	if(pcModel->m_dwFlags2 & 0x00000010)
		cmReturn << DWORD(0x00080008);
		
	if(pcModel->m_dwFlags2 & 0x00080000)
		cmReturn << DWORD(0x08000000);
...
/**
 *	Handles the message sent for the creation of trade skill materials in a container.
 *
 *	This function is called whenever a trade skill material should be created in the inventory of another object.
 *
 *	@return cMessage - Returns a Create Object (0x0000F745) server message.
 */
cMessage cTradeSkillMats::CreatePacketContainer(DWORD Container, DWORD ItemModelID)
{
	cMessage cmReturn;
...
/**
 *	Handles the actions of trade skill material objects.
 *
 *	This function is called whenever trade skill material is used or should perform an action.
 */
void cTradeSkillMats::Action(cClient *who)
{

}

/**
 *	Handles the assessment of trade skill material objects.
 *
 *	This function is called whenever trade skill material is assessed by a client.
 *
 *	Returns a Game Event (0x0000F7B0) server message of type Identify Object (0x000000C9).
 */
void cTradeSkillMats::Assess( cClient *pcAssesser )
{
	cItemModels *pcModel = cItemModels::FindModel( m_dwItemModelID );
