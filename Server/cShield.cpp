...
/**
 *	@file cShield.cpp
 *	Implements functionality for shields.
 *
 *	This class is referenced whenever a shield is created, used, or assessed.
...
/**
 *	Handles the message sent for the creation of shields in the world.
 *
 *	This function is called whenever a shield should be created in the world for a client.
 *
 *	@return cMessage - Returns a Create Object (0x0000F745) server message.
 */
cMessage cShield::CreatePacket( )
{
	cMessage cmReturn;
 ...
 *	@return cMessage - Returns a Create Object (0x0000F745) server message.
 */
cMessage cShield::CreatePacketContainer(DWORD Container, DWORD ItemModelID)
{
	cMessage cmReturn;
 ...
 */
void cShield::Action(cClient *who)
{
 ...
 */
void cShield::Assess( cClient *pcAssesser )
{
	cItemModels *pcModel = cItemModels::FindModel( m_dwItemModelID );
	...
	<< 0x1CL						//Armor Level
	<< pcAssesser->m_pcAvatar->myShield->m_dwArmorLevel						//AL 100
