...
/**
 *	@file cPlants.cpp
 *	Implements functionality for plants.
 *
 *	This class is referenced whenever a plant is created, used, or assessed.
...
/**
 *	Handles the message sent for the creation of plants in the world.
 *
 *	This function is called whenever a plant should be created in the world for a client.
 *
 *	@return cMessage - Returns a Create Object (0x0000F745) server message.
 */
cMessage cPlants::CreatePacket( )
{
	cMessage cmReturn;
 ...
 *	@return cMessage - Returns a Create Object (0x0000F745) server message.
 */
cMessage cPlants::CreatePacketContainer(DWORD Container, DWORD ItemModelID)
{
	cMessage cmReturn;
 ...
 */
void cPlants::Action(cClient *who)
{
 ...
 */
void cPlants::Assess( cClient *pcAssesser )
{
	cItemModels *pcModel = cItemModels::FindModel( m_dwItemModelID );
